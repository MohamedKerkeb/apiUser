...
const getData = async ()=>{
    ...
    for (const a of resFormat.data){
        let user = new _users.Users(a.avatar, a.first_name, a.last_name, a.email, a.id);
...
},{"../models/users":"fEUzp"}],"fEUzp":[function(require,module,exports) {
...
},{}]},["lVHAe","hOJOi"], "hOJOi", "parcelRequireaf42")
